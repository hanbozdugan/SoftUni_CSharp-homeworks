//13. We have a report that holds dates, web site 
//URLs and load times (in seconds) in the same 
//format like in the examples below. Your tasks 
//is to calculate the average load time for each 
//URL. Print the URLs in the same order as they 
//first appear in the input report. Print the output
//in the format given below. Use double floating-point precision. 
using System;
